...
**Facebook makes the same container call and is NOT one of them**, which is worth stating because the
first version of this section counted it as a fourth. Losing that call on Facebook is not a failure:
the arm falls through to the page and to Meta's embed-plugin fragment, and the fragment alone
